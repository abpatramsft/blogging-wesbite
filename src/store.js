// Post persistence for the blogging website.
//
// Posts are stored as Markdown files with a small YAML-ish frontmatter block
// under `<root>/content/posts/<slug>.md`. Treating the file path as the durable
// id keeps posts inspectable on disk and committable to the repo.
